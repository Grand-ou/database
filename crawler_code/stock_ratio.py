...
class StockRatio(CrawlerBase):
    def __init__(self, time, path):
        ...
        self.url = 'https://www.twse.com.tw/exchangeReport/BWIBBU_d?response=csv&date=' + time.strftime('%Y%m%d') + '&selectType=ALL'
    ...
    def  processing(self):
        ...
        print(line)
        header = ['date', 'securities_code', 'securities_name', 'dividend_year', 'P/E_ratio', 'Fiscal_year_quarter']
